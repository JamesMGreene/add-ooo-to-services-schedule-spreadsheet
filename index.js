...
async function main() {
  ...
  tools.log.info(JSON.stringify(Array.isArray(sheet.properties) ? sheet.properties.slice(0, 1) : Object.keys(sheet.properties)))
  tools.log.info('sheets[0].conditionalFormats:')
  tools.log.info(JSON.stringify(Array.isArray(sheet.conditionalFormats) ? sheet.conditionalFormats.slice(0, 1) : Object.keys(sheet.conditionalFormats)))
  tools.log.info('sheets[0].bandedRanges:')
  tools.log.info(JSON.stringify(Array.isArray(sheet.bandedRanges) ? sheet.bandedRanges.slice(0, 1) : Object.keys(sheet.bandedRanges)))
  tools.log.info('sheets[0].data:')
  tools.log.info(JSON.stringify(Array.isArray(sheet.data) ? sheet.data.slice(0, 1) : Object.keys(sheet.data)))
