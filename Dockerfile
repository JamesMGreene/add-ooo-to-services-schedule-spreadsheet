...
LABEL "com.github.actions.name"="add-ooo-to-spreadsheet"
...
LABEL "repository"="https://github.com/github/services/.github/actions/add-ooo-to-spreadsheet"
LABEL "homepage"="https://github.com/github/services/.github/actions/add-ooo-to-spreadsheet"
